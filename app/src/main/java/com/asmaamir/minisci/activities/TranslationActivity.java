...
import com.asmaamir.minisci.analyzers.TranslationAnalyzer;
...
public class TranslationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textureView = findViewById(R.id.texture_view_translate);
        imageView = findViewById(R.id.image_view_translate);
    ...
    private void initCamera() {
        ...
        TranslationAnalyzer translationAnalyzer = new TranslationAnalyzer(textureView, imageView, lens, this, facenet);
        imageAnalysis.setAnalyzer(Runnable::run, translationAnalyzer);
    ...
    private void startCamera() {
        initCamera();
        ImageButton ibSwitch = findViewById(R.id.fab_switchcam_translate);
